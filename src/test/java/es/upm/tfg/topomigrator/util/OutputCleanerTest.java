...
public class OutputCleanerTest {
    ...
    @Test
    public void cleanOutputsRemovesRuntimeErrorsTracesAndFlowsButPreservesStateAndLogs() throws Exception {
        ...
        Path flowFile = outputs.resolve("flows/generated-flow.json");
        ...
        Files.writeString(flowFile, "stale flow");
